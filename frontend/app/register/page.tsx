...
import { FiMail, FiLock, FiUser, FiVideo } from 'react-icons/fi';
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-3 text-white mb-2">
            ...
            <h1 className="text-4xl font-bold">StreamBox</h1>
          </div>
          <p className="text-white/80">Créez votre compte gratuitement</p>
        </div>
